...
BATTLE_TARGETS = {
    ...
    "gpt-4-turbo": {"gpt-4-0613", "gpt-3.5-turbo-0613", "gpt-3.5-turbo-1106", "claude-2.1"},
    ...
    "solar-10.7b-instruct-v1.0": {"mixtral-8x7b-instruct-v0.1", "gpt-3.5-turbo-0613", "llama-2-70b-chat"},
    ...
    "openhermes-2.5-mistral-7b": {"gpt-3.5-turbo-0613", "openchat-3.5", "zephyr-7b-beta"},
    "dolphin-2.2.1-mistral-7b": {"gpt-3.5-turbo-0613", "vicuna-33b", "starling-lm-7b-alpha", "openhermes-2.5-mistral-7b"},
